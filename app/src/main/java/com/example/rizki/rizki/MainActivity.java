package com.example.rizki.rizki;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void openmaps(View v){
        ...
        Uri uri = Uri.parse("https://www.google.com/maps/search/semarang/@-7.005624, 110.426573");
    ...
    public void openemail(View v){
        ...
        i.putExtra(Intent.EXTRA_EMAIL  , new String[]{"rizki09775@gmail.com"});
        try {
